...
class Order(db.Model):
    ...
    user_id = db.Column(db.Integer, index=True)  # from JWT; no User table here
    ...
    limit_price_cents = db.Column(db.Integer, nullable=True)  # price in cents for limit orders
